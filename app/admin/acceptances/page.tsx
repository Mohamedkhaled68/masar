...
import { acceptanceAPI, specialtyAPI } from "@/lib/api/axios";
import {
    Shield,
    LogOut,
    Clock,
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-zinc-400">
                                    مراجعة وإدارة طلبات قبول المدارس للمعلمين
                                </p>
                            </div>
                        </div>
                        <button
                                                    ...
                                                    {acceptance.teacher
                                                        ...
                                                        <div className="flex items-center gap-2 text-sm text-zinc-400">
                                                            ...
                                                            <span>
                                                                هاتف المعلم:{" "}
                                                                <a
                                                                    href={`https://wa.me/${acceptance.teacher.phoneNumber.replace(
                                                                        /[^0-9]/g,
                                                                        ""
                                                                    )}`}
                                                                    target="_blank"
                                                    ...
                                                    {acceptance.school
                                                        ...
                                                        <div className="flex items-center gap-2 text-sm text-zinc-400">
                                                            ...
                                                            <span>
                                                                واتساب المدرسة:{" "}
                                                                <a
                                                                    href={`https://wa.me/${acceptance.school.whatsappPhone.replace(
                                                                        /[^0-9]/g,
                                                                        ""
                                                                    )}`}
                                                                    target="_blank"
